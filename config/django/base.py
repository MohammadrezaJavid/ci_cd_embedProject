...
DATABASES = {
    'default': env.db('DATABASE_URL', default='psql://user:password@127.0.0.1:5432/jlinux'),
}
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'jlinux.api.exception_handlers.drf_default_with_modifications_exception_handler',
    # 'EXCEPTION_HANDLER': 'jlinux.api.exception_handlers.hacksoft_proposed_exception_handler',
